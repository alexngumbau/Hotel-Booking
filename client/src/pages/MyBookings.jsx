          ...
          >
            ...
            <div className="flex flex-col md:flex-row">
              <img
                ...
                alt="hotel-img"
                className="min-md:w-44 rounded-xl shadow object-cover"
              />
            ...
            <div className="flex flex-col items-start justify-center pt-3">
              ...
              {!booking.isPaid && (
                <button className="px-4 py-1.5 mt-4 text-xs border border-gray-400 rounded-full hover:bg-gray-300 transition-all cursor-pointer">Pay Now</button>
              )}
            </div>
          </div>
        ))}
